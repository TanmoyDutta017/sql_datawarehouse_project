...
- **Naming Conventions**: Use snake_case, with lowercase letters and underscore (`_`) to separte words.
...
- **`<sourcesystem>_<entity>`**
    -`<sourcesystem>` : Name of the sourece system (e.g, `crm`, `erp`).
